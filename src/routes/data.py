...
from models.db_shcemes import DataChunk, Asset
...
async def process_endpoint(request: Request, process_request: ProcessRequest, project_id: str):
    ...
    return JSONResponse(
        content={
            ...
            "inserted_chunks": no_records_inserted
        }
    )